...
@Component({
  selector: 'app-create-password-company',
  imports: [ReactiveFormsModule, CommonModule, TitleCasePipe, TranslateModule],
  templateUrl: './create-password-company.component.html',
  styleUrl: './create-password-company.component.scss'
})
export class CreatePasswordCompanyComponent implements OnInit {
